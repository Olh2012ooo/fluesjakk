...
export const CLASS_COLORS = {
  retina: [214, 255, 150],
  optic: [88, 211, 232], central: [255, 160, 80], sensory: [182, 240, 74], visual_projection: [110, 198, 234],
  visual_centrifugal: [130, 160, 240], ascending: [255, 200, 110], descending: [255, 120, 90], motor: [255, 90, 80],
  sensory_ascending: [148, 214, 96], endocrine: [230, 130, 200], unknown: [131, 140, 148],
};

/** Norske visningsnavn på nevronklassene (brukes i fargeforklaringen og diagrammet). */
export const KLASSE_NAVN = {
  retina: 'netthinnen', optic: 'lobula', central: 'sentralhjernen', sensory: 'sanseceller',
  visual_projection: 'synsprojeksjon', visual_centrifugal: 'synscentrifugal', ascending: 'oppstigende',
  descending: 'nedstigende', motor: 'motoriske', sensory_ascending: 'sanse-oppstigende',
  endocrine: 'endokrine', unknown: 'ukjente',
};
...
// ============================================================================ strip chart
const SHORT_NAMES = {
  visual_projection: 'synsproj.', visual_centrifugal: 'synssentr.', sensory_ascending: 'sanse-oppst.',
  sensory: 'sanse', descending: 'nedstig.', central: 'sentral', retina: 'netthinne',
};
/**
